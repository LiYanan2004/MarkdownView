...
public enum MarkdownElementRendererRegistration {
    ...
    package var renderer: any MarkdownElementRenderer {
        switch self {
    ...
    package var blockDirective: (name: String, renderer: any MarkdownBlockDirectiveRenderer)? {
    ...
    package var image: (scheme: String, renderer: any MarkdownImageRenderer)? {
    ...
    package var link: (scheme: String, renderer: any MarkdownLinkRenderer)? {
...
extension MarkdownElementRendererRegistration {
    package func matches(_ other: MarkdownElementRendererRegistration) -> Bool {
        switch (self, other) {
...
extension Array where Element == MarkdownElementRendererRegistration {
    package mutating func register(_ registration: MarkdownElementRendererRegistration) {
