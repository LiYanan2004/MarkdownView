...
public struct AnyHeadingStyleGroup: Sendable {
    package var _h1: AnyShapeStyle
    package var _h2: AnyShapeStyle
    package var _h3: AnyShapeStyle
    package var _h4: AnyShapeStyle
    package var _h5: AnyShapeStyle
    package var _h6: AnyShapeStyle
    
    package init(_ group: some HeadingStyleGroup) {
