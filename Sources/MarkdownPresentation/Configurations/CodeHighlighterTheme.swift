...
public struct CodeHighlighterTheme: Hashable, Sendable {
    package var lightModeThemeName: String
    package var darkModeThemeName: String
    ...
    package func themeName(for colorScheme: ColorScheme) -> String {
        switch colorScheme {
        case .light:
            lightModeThemeName
        case .dark:
...
extension CodeHighlighterTheme {
    package static let `default` = CodeHighlighterTheme(lightModeThemeName: "xcode", darkModeThemeName: "dark")
}
