...
package struct FlowLayout: Layout {
    package typealias Cache = [ViewRect]
    
    package var verticleSpacing: CGFloat = 0
    
    package init(verticleSpacing: CGFloat = 0) {
        self.verticleSpacing = verticleSpacing
    }
...
extension FlowLayout {
    package struct ViewRect: Equatable {
