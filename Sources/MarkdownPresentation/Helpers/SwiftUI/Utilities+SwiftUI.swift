...
extension View {
    ...
    package func _task<E: Equatable>(id: E, priority: TaskPriority = .userInitiated, @_inheritActorContext _ action: @escaping @Sendable () async -> Void) -> some View {
...
extension View {
    ...
    package func _overlay(alignment: Alignment = .center, @ViewBuilder content: @escaping () -> some View) -> some View {
