...
///
/// To configure the current font group for a view hierarchy, use the `markdownFontGroup(_:)` modifier. Specify a font group that conforms to `MarkdownFontGroup` when creating a markdown view.
