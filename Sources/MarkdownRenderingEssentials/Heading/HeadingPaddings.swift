...
package struct HeadingPaddings: Sendable {
    ...
    package subscript(level: Int) -> EdgeInsets {
        get {
    ...
    package subscript(level: Int, edge: Edge) -> CGFloat {
        get {
...
package struct HeadingPaddingsEnvironmentKey: EnvironmentKey {
    package static let defaultValue: HeadingPaddings = .init()
}

extension EnvironmentValues {
    package var headingPaddings: HeadingPaddings {
